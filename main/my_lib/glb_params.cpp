...
i2s_chan_handle_t    audio_tx      = NULL;
i2s_chan_handle_t    audio_rx      = NULL;
...
volatile bool        play_test_running = false;
volatile bool        sample_task_running = false;
volatile bool        wav_task_running = false;
i2s_mode_t           current_i2s_mode = I2S_MODE_NONE;
